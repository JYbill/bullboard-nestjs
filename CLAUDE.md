...
- 测试与质量工具：Jest、ts-jest、Supertest、ESLint 9、typescript-eslint、Prettier 3。
...
# 测试
pnpm exec jest src/path/to/file.spec.ts
pnpm exec jest src/path/to/file.integration-spec.ts
